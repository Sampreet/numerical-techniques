import sys
sys.path.append(".")
from modules import find_root_uni as fru
import math 
...
root, ic = fru.bisection(f1, xi, xf, et)
if root != None:
...
root, ic = fru.false_position(f1, xi, xf, et)
if root != None:
...
root, ic = fru.newton_raphson(f1, df1, xi, et, mi)
if root != None:
...
root, ic = fru.secant(f1, xi, xf, et, mi)
if root != None:
    print("Secant Method:\n\tRoot: {x0}\n\tFunction Value: {fx0}\n\tIterations: {ic}".format(x0=root, fx0=f1(root), ic=ic))
else:
