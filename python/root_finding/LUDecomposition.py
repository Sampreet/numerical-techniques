"""
A collection of methods to find solutions of a system of linear equations using LU Decomposition Method.
"""

__all__ = ["get_LU_with_ones_in_L", "get_root_of_L", "get_root_of_U", "solve_with_ones_in_L"]
...
def solve_with_ones_in_L(A, b):
    """
    Find the roots of a given system of linear equations represented as A*x = b using LU Decomposition Method.
