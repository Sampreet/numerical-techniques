...
"""Example code to use root_finding -> JacobiIteration module."""
...
# dependencies
from modules.root_finding import JacobiIteration
...
# function
root, ops, msg = JacobiIteration.get_solution_basic(A, b, x, lamb, imax, et, True)
