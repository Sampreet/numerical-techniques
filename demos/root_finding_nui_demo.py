import sys
sys.path.append(".")
from modules import root_finding as rfm
import math
...
root, ic = rfm.bisection(f1, xi, xf, et)
if root != None:
...
root, ic = rfm.false_position(f1, xi, xf, et)
if root != None:
...
root, ic = rfm.newton_raphson(f1, df1, xi, et, mi)
if root != None:
...
root, ic = rfm.secant(f1, xi, xf, et, mi)
if root != None:
    print("Secant Method:\n\tRoot: {x0}\n\tFunction Value: {fx0}\n\tIterations: {ic}".format(x0=root, fx0=f1(root), ic=ic))
else:
